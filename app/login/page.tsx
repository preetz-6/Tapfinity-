...
export default function Login() {
  ...
  useEffect(() => {
    if (status === "authenticated") {
      ...
      else if (r === "STAFF") router.replace("/staff");
      ...
      <div className="flex flex-col items-center justify-center p-6 relative">
        ...
        <div className="w-full max-w-sm relative z-10">
          ...
          <div className="lg:hidden text-center mb-10 w-full flex flex-col items-center">
            ...
            <p className="text-sm text-on-surface-variant">Sign in to your student account</p>
          </div>

          <div className="mb-8 hidden lg:block">
            <h2 className="text-3xl font-bold tracking-tight mb-2">Student Sign In</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-surface-container-high border border-outline-variant/20 rounded-xl px-4 py-3.5 text-white placeholder-outline-variant outline-none transition-all focus:ring-secondary/40 focus:bg-surface-container-highest"
                  value={email}
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    placeholder="••••••••"
                    className="w-full bg-surface-container-high border border-outline-variant/20 rounded-xl px-4 py-3.5 pr-12 text-white placeholder-outline-variant outline-none transition-all focus:ring-secondary/40 focus:bg-surface-container-highest"
                    value={password}
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-gradient-to-r from-secondary to-purple-600 text-white font-bold py-4 rounded-xl shadow-lg transition-all active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 hover:brightness-110"
              >
                {loading ? (
                  <>
